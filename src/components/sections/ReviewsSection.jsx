        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl sm:text-4xl">
              Bemorlar taassurotlarini ulashadi
            </h2>
          </div>
          <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-xs font-semibold text-[color:var(--muted)]">
            Fikrlar administrator tomonidan moderatsiya qilinadi
          </span>
        </div>
        {isLoading ? (
          <p className="mt-6 text-sm text-[color:var(--muted)]">Fikrlar yuklanmoqda...</p>
        ) : null}
